 ...
 * define
 */
#define		SERVER_RECORDER_VERSION_STRING		"alpha-8.1"
...
#define		MSG_RECORDER_CLEAN_DISK_START			(MSG_RECORDER_BASE | 0x0103)
#define		MSG_RECORDER_CLEAN_DISK_STOP			(MSG_RECORDER_BASE | 0x0104)
...
#define		RECORDER_TYPE_HUMAN_DETECTION			0x03
